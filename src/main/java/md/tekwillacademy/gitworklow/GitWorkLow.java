package md.tekwillacademy.gitworklow;

public class GitWorkLow {
    public static void main(String[] args) {
        String step1 = "Execute git stash in the colone";
        String step2 = "Perform git checkout master - to move to the local master branch";
        String step3 = "Execute git fetch command - to see if there are any change son remote/origin";
        ...
        String step11 = "Add the Pull Request details  like name, description reviewers";
        String step12 = "If we collect at least 1 approval then we can merge the changes and continue with another task";
        String step13 = "Do not forget that locally are still on the New_Name_Branch";
